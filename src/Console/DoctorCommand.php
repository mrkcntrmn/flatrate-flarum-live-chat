...
class DoctorCommand extends AbstractCommand
{
    ...
    protected function fire()
    {
        ...
        $lines = [
            ...
            'WEBSOCKET_URL_SOURCE=' . $diag['websocketUrlSource'],
            'PUBLISH_URL_SOURCE=' . $diag['publishUrlSource'],
            'EDGE_KEY_SOURCE=' . $diag['edgeKeySource'],
            'API_KEY_SOURCE=' . $diag['apiKeySource'],
            'JWT_PRIVATE_KEY_SOURCE=' . $diag['jwtPrivateKeySource'],
            'SECRET_MODE=' . $diag['secretMode'],
